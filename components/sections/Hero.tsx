  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex max-w-5xl flex-col items-center px-4">
        ...
        {/* 動物キャラ（FVヒーロー） */}
        <div className="relative mt-2 h-48 w-full max-w-md sm:h-64">
          <ParrotKoko
            decorative
            className="absolute left-2 top-0 h-36 w-36 animate-floaty sm:h-44 sm:w-44"
            style={{ animationDelay: '0s' }}
          />
          <HippoPoko
            decorative
            className="absolute bottom-0 right-1 h-40 w-40 animate-floaty sm:h-48 sm:w-48"
            style={{ animationDelay: '1s' }}
          />
          <MonkeyMaru
            decorative
            className="absolute bottom-4 left-1/2 h-32 w-32 -translate-x-1/2 animate-floaty sm:h-40 sm:w-40"
        ...
        {/* キャラ紹介 */}
        <div className="mt-8 grid w-full max-w-md grid-cols-2 gap-3 sm:max-w-2xl sm:grid-cols-3">
